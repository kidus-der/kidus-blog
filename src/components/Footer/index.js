  ...
  return (
    <footer className="mt-16 rounded-2xl bg-dark m-10 flex flex-col items-center text-light">
      ...
      <div className="flex items-center mt-8">
        ...
        <a href="http://example.com" className="inline-block h-6 w-6 mr-4 fill-light">
      ...
      <div className="w-full mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex flex-row items-center justify-between">
        <span className="text-center">&copy;2025 Kidus Zewde. All rights reserved</span>
        <Link href="/sitemap.xml" className="text-center underline">
            sitemap.xml
        </Link>

        <div className="text-center">
            Made with &hearts; by <a href="https://kiduszewde.blog" className="underline">Kidus Zewde</a>
        </div>
      </div>
    </footer>
  );
